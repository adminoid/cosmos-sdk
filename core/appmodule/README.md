...
message Module {
  option (cosmos.app.v1alpha1.module) = {
    go_import: "github.com/adminoid/cosmos-sdk/x/auth"
  };
...
Alternatively, the `depinject.Config` can be created via [pure Go code](https://github.com/adminoid/cosmos-sdk/blob/61dc023/simapp/app_config.go).
