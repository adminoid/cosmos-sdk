...
const (
	...
	ormListPkg  = protogen.GoImportPath("github.com/adminoid/cosmos-sdk/orm/model/ormlist")
	ormErrPkg   = protogen.GoImportPath("github.com/adminoid/cosmos-sdk/orm/types/ormerrors")
	ormTablePkg = protogen.GoImportPath("github.com/adminoid/cosmos-sdk/orm/model/ormtable")
)
