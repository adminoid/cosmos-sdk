...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/client/context.go#L25-L63
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/staking/client/cli/query.go#L323-L326
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/staking/client/cli/query.go#L317-L341
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/client/query.go#L80-L114
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/client/context.go#L315-L343
```
