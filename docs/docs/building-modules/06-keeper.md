...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/staking/keeper/keeper.go#L21-L29
```
...
For more, see an example of `keeper`'s [methods implementation from the `staking` module](https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/staking/keeper/keeper.go).
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/auth/keeper/account.go#L76-L90
```
