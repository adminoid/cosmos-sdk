...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/types/tx_msg.go#L10-L22
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/auth/migrations/legacytx/stdsign.go#L20-L36
```

See an example implementation of a `message` from the `gov` module:

```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/gov/types/v1/msgs.go#L106-L138
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/baseapp/abci.go#L756-L777
```
