...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/bank/types/tx.pb.go#L288-L294
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/bank/keeper/msg_server.go#L14-L16
```

`msgServer` methods can retrieve the `sdk.Context` from the `context.Context` parameter method using the `sdk.UnwrapSDKContext`:

```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/bank/keeper/msg_server.go#L27-L27
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/baseapp/msg_service_router.go#L127
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/base/abci/v1beta1/abci.proto#L88-L109
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/auth/vesting/msg_server.go#L73-L85
```
