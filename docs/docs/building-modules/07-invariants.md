...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/types/invariant.go#L9
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/staking/keeper/invariants.go#L12-L21
```

For more, see an example of [`Invariant`s implementation from the `staking` module](https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/staking/keeper/invariants.go).
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/types/invariant.go#L14-L17
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/crisis/keeper/keeper.go#L49-L53
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/crisis/abci.go#L12-L21
```
