...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/auth/v1beta1/genesis.proto
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/auth/module.go#L45-L49
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/auth/types/genesis.go#L61-L74
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/auth/keeper/genesis.go#L8-L27
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/auth/keeper/genesis.go#L29-L41
```
