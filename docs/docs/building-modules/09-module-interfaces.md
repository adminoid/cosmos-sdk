...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/bank/client/cli/tx.go#L35-L71
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/bank/client/cli/tx.go#L17-L33
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/bank/module.go#L70-L73
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/auth/client/cli/query.go#L83-L125
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/auth/client/cli/query.go#L25-L42
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/auth/client/cli/query.go#L32-L50
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/client/flags/flags.go#L103-L131
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/client/flags/flags.go#L92-L101
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/auth/module.go#L61-L66
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/auth/v1beta1/query.proto#L13-L59
```
