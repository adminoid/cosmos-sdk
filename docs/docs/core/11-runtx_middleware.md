...
More context can found in the corresponding [ADR-022](../architecture/adr-022-custom-panic-handling.md) and the implementation in [recovery.go](https://github.com/adminoid/cosmos-sdk/tree/v0.46.0/baseapp/recovery.go).

## Interface

```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/baseapp/recovery.go#L11-L14
```
