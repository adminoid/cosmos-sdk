...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/server/types/app.go#L45-L47
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/bank/v1beta1/query.proto#L19-L22
```
...
The Cosmos SDK's [Swagger generation script](https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/scripts/protoc-swagger-gen.sh) is a good place to start.
