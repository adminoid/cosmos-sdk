...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/types/config.go#L14-L29
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/simapp/simd/main.go
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/server/start.go#L211
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/simapp/simd/cmd/root.go#L246-L295
```

Then, the instance of `app` is used to instantiate a new Tendermint node:

```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/server/start.go#L291-L294
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/server/start.go#L296-L298
```
