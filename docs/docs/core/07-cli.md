...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/simapp/simd/main.go#L12-L24
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/simapp/simd/cmd/root.go#L39-L85
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/simapp/simd/cmd/root.go#L175-L181
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/simapp/simd/cmd/root.go#L215-L240
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/simapp/simd/cmd/root.go#L191-L213
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/simapp/simd/cmd/root.go#L210-L210
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/simapp/simd/cmd/root.go#L56-L79
```
