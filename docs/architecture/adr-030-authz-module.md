...
delegated stake
* "sub-keys" functionality, as originally proposed in [\#4480](https://github.com/adminoid/cosmos-sdk/issues/4480) which
is a term used to describe the functionality provided by this module together with
the `fee_grant` module from [ADR 029](./adr-029-fee-grant-module.md) and the [group module](https://github.com/adminoid/cosmos-sdk/tree/main/x/group).
...
* B-Harvest subkeys spec: https://github.com/adminoid/cosmos-sdk/issues/4480
