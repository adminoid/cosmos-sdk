...
Currently, KVStore data can be remotely accessed through [Queries](https://github.com/adminoid/cosmos-sdk/blob/master/docs/building-modules/messages-and-queries.md#queries)
