...
`x/evidence` is an implementation of a Cosmos SDK module, per [ADR 009](https://github.com/adminoid/cosmos-sdk/blob/main/docs/architecture/adr-009-evidence-module.md),
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.1/proto/cosmos/evidence/v1beta1/evidence.proto#L11-L22
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/83260b0c2f9afcc7ec94a102f83906e8e56ef18e/x/evidence/keeper/infraction.go#L26-L140
```
