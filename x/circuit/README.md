...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/main/proto/cosmos/circuit/v1/tx.proto#L25-L75
```
...
```protobuf reference 
https://github.com/adminoid/cosmos-sdk/blob/main/proto/cosmos/circuit/v1/tx.proto#L77-L93
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/main/proto/cosmos/circuit/v1/tx.proto#L95-109
```
