...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/group/types.go#L27-L41
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L66-L78
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L87-L100
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L105-L117
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L122-L134
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L143-L160
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L183-L206
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L169-L181
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L219-L235
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L240-L252
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L275-L298
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L307-L316
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L321-L339
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L341-L353
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/group/v1/tx.proto#L362-L370
```
