...
`x/authz` is an implementation of a Cosmos SDK module, per [ADR 30](https://github.com/adminoid/cosmos-sdk/blob/main/docs/architecture/adr-030-authz-module.md), that allows
...
on behalf of one account to other accounts. The design is defined in the [ADR 030](https://github.com/adminoid/cosmos-sdk/blob/main/docs/architecture/adr-030-authz-module.md).
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/authz/authorizations.go#L11-L25
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/authz/v1beta1/authz.proto#L13-L20
```

```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/authz/generic_authorization.go#L16-L29
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/bank/v1beta1/authz.proto#L10-L19
```

```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/bank/types/send_authorization.go#L23-L38
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/staking/v1beta1/authz.proto#L10-L33
```

```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/staking/types/authz.go#L15-L35
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/authz/v1beta1/authz.proto#L22-L30
```
...
```go reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/x/authz/keeper/keys.go#L78-L93
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/authz/v1beta1/tx.proto#L32-L41
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/authz/v1beta1/tx.proto#L66-L72
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/authz/v1beta1/tx.proto#L51-L59
```
