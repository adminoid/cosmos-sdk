...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0/proto/cosmos/slashing/v1beta1/slashing.proto#L12-L33
```
...
```protobuf reference
https://github.com/adminoid/cosmos-sdk/blob/v0.46.0-rc3/proto/cosmos/slashing/v1beta1/slashing.proto#L35-L45
```
...
> be changed to jailed/unjailed. See issue [#3205](https://github.com/adminoid/cosmos-sdk/issues/3205)
