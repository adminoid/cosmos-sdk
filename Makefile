...
HTTPS_GIT := https://github.com/adminoid/cosmos-sdk.git
...
ldflags = -X github.com/adminoid/cosmos-sdk/version.Name=sim \
		  -X github.com/adminoid/cosmos-sdk/version.AppName=simd \
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/adminoid/cosmos-sdk/types"
	godoc -http=:6060
...
devdoc-init:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/adminoid/cosmos-sdk" -w "/go/src/github.com/adminoid/cosmos-sdk" tendermint/devdoc echo
	# TODO make this safer
	$(call DEVDOC_SAVE)

devdoc:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/adminoid/cosmos-sdk" -w "/go/src/github.com/adminoid/cosmos-sdk" devdoc:local bash
